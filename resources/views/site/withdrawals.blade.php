  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <main class="col-md-9">
        ...
        <div class="row">
          <div class="col-md-12">
            <article class="card p-4 bg-primary"> <div class="row align-items-center"> <div class="col">  <p class="mb-0 text-white-50"> الارباح الحالهي الغير مسحوبه هيا : 90 جنيه </p> </div> <div class="col-auto"> <a class="btn btn-warning" href="{{ route('site.withdrawals.create') }}"> سحب الارباح </a> </div> </div></article>
          </div>
        </div>
        <div class="row">
         <div class="col-md-12">
